...
public class AirlineUtils {
    ...
    public  void allocateSeats(String str, int passengersCount)  {
        ...
        printValues(lists, colSize, rowSize);
    ...
    private  void printValues(List<List<String[]>> seats, int colSize, int rowSize)  {
